	...
	<section class="text-primary-600 body-font">
		<div class="container px-5 py-24 mx-auto flex flex-wrap">
			...
			>
				...
				<div
					class="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-primary-500 text-white relative z-10 title-font font-medium text-sm"
				>
					1
				</div>
				<div
				...
				>
					<div
						class="flex-shrink-0 w-24 h-24 bg-primary-100 text-primary-500 rounded-full inline-flex items-center justify-center"
					>
						<svg
